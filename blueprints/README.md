...
1. Import the blueprint in Home Assistant
   + Blueprint import url: https://github.com/iamjoshk/home-assistant-collection/blob/main/blueprints/voice-assist/roll-dice/voice-assist-roll-die.yaml
3. Download and move the `roll_dice.py` pyscript to the `config/pyscript` directory
